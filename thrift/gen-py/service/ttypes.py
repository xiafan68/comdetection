...
class WorkStatus:
  ...
  def __init__(self, worker=None, totalTime=None, totalIds=None, recentTime=None, recentIds=None,):
    self.worker = worker
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.totalTime)
    value = (value * 31) ^ hash(self.totalIds)
    value = (value * 31) ^ hash(self.recentTime)
    value = (value * 31) ^ hash(self.recentIds)
    return value
